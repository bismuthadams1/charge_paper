...
if __name__ == "__main__":
    input_file = "/scratch/users/k2584788/charge_paper/comparison_of_charge_models/charge_models_test_withgeoms.parquet"
    output = "/scratch/users/k2584788/charge_paper/comparison_of_charge_models/charge_models_test_withgeoms_and_additional_models_test.parquet"
